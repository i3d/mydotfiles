...
if ((  $NEED_INSTALL_BREW )); then
  ...
  brew install \
    gettext autoconf automake base64 bison cmake gcc global intltool \
  ...
  echo "Install last commands for zsh ..."
  brew install hub fasd fortune lolcat neofetch
fi
