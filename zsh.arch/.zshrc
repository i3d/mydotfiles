...
source $HOME/src/src/awesome-terminal-fonts/fonts/*.sh
...
export PATH=/usr/local/bin:/usr/local/sbin:/usr/local/symlinks:/usr/local/scripts:/usr/bin:/bin:/usr/sbin:/sbin:/opt/X11/bin:/usr/local/bin/g4bin:/usr/X11R6/bin
export CSCOPE_DB=/home/jimxu/src/src/linux/cscope.out

# Initialize HOMEBREW PATHs and ENVs before we add our own.
HOMEBREW_PREFIX=/home/linuxbrew/.linuxbrew
eval $(${HOMEBREW_PREFIX}/bin/brew shellenv)
# don't write build temps to /tmp, it's not big enough.
export HOMEBREW_TEMP=$HOME/src/tmp
...
#[ -f /home/jimxu/.linuxbrew/opt/fzf/shell/completion.zsh ] &&  source /home/jimxu/.linuxbrew/opt/fzf/shell/completion.zsh
#[ -f /home/jimxu/.linuxbrew/opt/fzf/shell/key-bindings.zsh ] &&  source /home/jimxu/.linuxbrew/opt/fzf/shell/key-bindings.zsh
...
#
#source /home/jimxu/.linuxbrew/share/antigen/antigen.zsh
# source /home/jimxu/.zprezto/init.zsh
...
#.linuxbrew cleanup previous installs.
export HOMEBREW_INSTALL_CLEANUP=1
#or run this to cleanup.

#export CPLUS_INCLUDE_PATH=/home/jimxu/.linuxbrew/Cellar/gcc/HEAD-2d3af38/include/c++/9.0.1:/usr/include:/usr/local/include:$HOME/.local/include:$CPLUS_INCLUDE_PATH
# for oni finding neovim
export ONI_NEOVIM_PATH=/home/jimxu/.linuxbrew/bin/nvim
...
alias vz='zshrc'
alias z1='v -O $HOME/.zshrc'
alias z2='v -O $HOME/.zshrc.pre-oh-my-zsh'
alias vcheat='v $HOME/bin/cheat'
# make sure any override of vim alias to .linuxbrew's version (the version I use)
...
#source /home/jimxu/linuxbrew/.linuxbrew/share/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
#export ZSH_HIGHLIGHT_HIGHLIGHTERS_DIR=/home/jimxu/.linuxbrew/share/zsh-syntax-highlighting/highlighters
#
...
# both can try.
#BASE16_SHELL="$HOME/src/src/vim-hybrid-material/base16-material/base16-material.dark.sh"
#[[ -s $BASE16_SHELL ]] && source $BASE16_SHELL
#
#BASE16_SHELL="$HOME/src/src/base16-shell/"
#[ -n "$PS1" ] && \
#[ -s "$BASE16_SHELL/profile_helper.sh" ] && \
#eval "$("$BASE16_SHELL/profile_helper.sh")"
...
export PATH=/home/jimxu/.cargo/bin:/home/jimxu/src/src/Nim/bin:$PATH
export RUST_SRC_PATH="$(rustc --print sysroot)/lib/rustlib/src/rust/src"

# parth/dotfiles
export VISUAL=vim
stty -ixon
source $HOME/src/src/dotfiles/zsh/keybindings.sh
...
#source $HOME/src/src/dotfiles/zsh/prompt.sh
#export PATH=$PATH:$HOME/src/src/dotfiles/utils
...
zman() {
    if [[ -f allman.list ]]; then
        cat allman.list | fzf -q "$1" --prompt='man> ' | awk -F\( '{print $1}' | xargs -r man
    else
        allman | fzf -q "$1" --prompt='man> ' | awk -F\( '{print $1}' | xargs -r man
    fi
    # mak -k . wouldn't work on arch.
    # man -k . | fzf -q "$1" --prompt='man> '  \
}
source $HOME/src/src/zsh-interactive-cd/zsh-interactive-cd.plugin.zsh
# FZF functions #########################
#
